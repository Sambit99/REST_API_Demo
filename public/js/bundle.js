      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            console.log(res);
            if (res.data) document.cookie = "jwt=".concat(res.data.token, ";max-age=").concat(60 * 60 * 24 * 10); // console.log(res.headers);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            // console.log(data);
            document.cookie = "jwt=loggedOut;max-age=".concat(1);
            console.log(res);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FtYml0OTkiLCJhIjoiY2t3MGZ1Z3ZsOXNjMDMwcXBtdHA1dnprMyJ9.E-vgg0MXMJZJArdebhaKXw';
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(providedData, type) {
    var jwtToken, url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              ...
              if (res.data) document.cookie = "jwt=".concat(res.data.token, ";max-age=").concat(60 * 60 * 24 * 10);
            }
          ...
          case 11:
            ...
            (0, _alerts.showAlert)('error', _context.t0.respone.data.message);
